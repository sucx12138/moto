package com.soft.moto.config.aop;

import com.soft.moto.common.utils.ModelUtil;
...
public class ModelAspect {
    @Pointcut("execution(public * com.soft.moto.service.impl..save*(..))")
    public void saveAspect(){ }
    @Pointcut("execution(public * com.soft.moto.service.impl..insert*(..))")
    public void insertAspect(){ }
    @Pointcut("execution(public * com.soft.moto.service.impl..add*(..))")
    public void addAspect(){ }
    @Pointcut("execution(public * com.soft.moto.service.impl..update*(..))")
    public void updateAspect(){ }
    @Pointcut("execution(public * com.soft.moto.service.impl..edit*(..))")
